	...
	/* DEBUG #define's */
		...
		#define dcerr_filename_part (dcerr_filebasename + std::string( std::max(28 - (int)dcerr_filebasename.size(), 0), ' '))
		...
		#define dcerr_function_part (dcerr_function + "():" + std::string(std::max(28 - (int)dcerr_function.size(), 1), ' '))
